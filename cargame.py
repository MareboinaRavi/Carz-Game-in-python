#importing modules
'''
    FOR MORE COOL PROJECTS FOLLOW ME ON GITHUB.
    IF YOU LIKE MY PROJECT PLEASE GIVE A STAR.
    feel free to mail me at mareboinaravi446@gmail.com
...
pygame.display.set_caption("Racing Car Game by Mareboina Ravi")
...
def score_system(passed,score):
    font=pygame.font.SysFont(None,25)
    text=font.render("No. of Cars passed :-"+str(passed),True,black)
